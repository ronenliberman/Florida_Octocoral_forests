...
Data prep. 
I am using the "Cover_All.csv" dataset that was prepared by Alex Hiley

```{r}
Cover_All <- read.csv("~/Postdocing_NSU/Octocoral forests/Manuscript/scripts/Cover_All.csv")
# Convert Depth to numeric
Cover_All$Depth <- as.numeric(as.character(Cover_All$Depth))
Cover_All <- Cover_All[,-1] #remove extra column
#Cover_All <- Cover_All[Cover_All$SampleYear!='2012',]
Cover_All <- Cover_All[Cover_All$SiteID!='29',]
Cover_All <- Cover_All[Cover_All$SiteID!='90',]
